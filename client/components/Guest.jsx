  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 to-indigo-100 text-gray-800">
      ...
      <main className="flex flex-col md:flex-row items-center justify-center flex-grow p-8">
        ...
        <div className="max-w-lg space-y-6">
          ...
          <p className="text-gray-600 text-lg">
            This page shows you how to integrate Google Login with NextAuth.js
            in a clean and simple way. Follow the steps below to connect your
            app with Google authentication.
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-white rounded-xl shadow hover:shadow-lg transition">
              ...
              <p className="text-gray-600 text-sm">
                ...
                and configure the Google provider.
              </p>
            </div>
            <div className="p-4 bg-white rounded-xl shadow hover:shadow-lg transition">
              <h3 className="font-semibold text-indigo-600">
              ...
              <p className="text-gray-600 text-sm">
                Get <strong>Client ID</strong> & <strong>Client Secret</strong>{" "}
                from Google Cloud Console and add them to{" "}
            ...
            <div className="p-4 bg-white rounded-xl shadow hover:shadow-lg transition">
              ...
              <p className="text-gray-600 text-sm">
                ...
                in your login button to trigger Google login.
              </p>
            </div>
          </div>
      ...
      <footer className="bg-white text-center py-4 text-gray-500 text-sm shadow-inner">
        © {new Date().getFullYear()} My Next.js App. Built with ❤️ for
        developers.
      </footer>
    </div>
  );
